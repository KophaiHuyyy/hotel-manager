...
?>
        ...
        <head>
            ...
            <style>
                ...
                nav {
                    background: linear-gradient(90deg, rgba(2, 0, 36, 1) 0%, rgba(39, 55, 102, 1) 35%, rgba(67, 67, 115, 1) 100%);                    /* Blue background color */
                    padding: 10px 0;
        ...
        <body>
            <nav>
                <div class="container">
                    <a class="navbar-brand" style="text-transform: uppercase" href="#">sửa đặt phòng</a>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" style="text-transform: uppercase" href="FcheckIn.php">Trang Chủ</a>
                        </li>
            ...
            <div class="container">
                <form id="infoForm" action="update_checkin.php" method="post" onsubmit="return validateDates()">
