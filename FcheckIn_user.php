    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link task" href="FcheckIn_user.php">Đặt Phòng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link task" href="FcheckOut_user.php">Trả Phòng</a>
                </li>
            </ul>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="Datphong">
                ...
                <form id="infoForm" method="post" action="Datphong_user.php" onsubmit="return validateDates()">
